...
class LVUCLSDataset(VideoQADataset):
    ...
    def __getitem__(self, index):
        ...
        for frame_index in selected_frame_index:
            frame = Image.open(os.path.join('/lrh/VideoUnderstanding/datasets/MALMM_data/LVU_frames', self.annotation[video_start_id]['video_id'], "frame{:06d}.jpg".format(frame_index + 1))).convert("RGB")
