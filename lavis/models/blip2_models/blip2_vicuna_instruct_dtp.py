...
from lavis.models.blip2_models.dtp import DTP
from lavis.models.blip2_models.dtp_utils import DTPConfig


@registry.register_model("blip2_vicuna_instruct_dtp_malmm")
